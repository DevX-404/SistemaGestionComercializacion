      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label>RUC</label>
            <input v-model="form.ruc" type="text" maxlength="11" placeholder="Ej: 201000...">
          </div>
          <div class="form-group">
...
.btn-primary { background: #8950fc; color: white; border: none; padding: 10px 20px; border-radius: 8px; cursor: pointer; font-weight: 600; }
...
.monster-table td { padding: 15px; border-bottom: 1px solid #f5f7fb; color: #3f4254; }
...
.form-group input { width: 100%; padding: 10px; border: 1px solid #e4e6ef; border-radius: 6px; box-sizing: border-box; }
.row { display: flex; gap: 15px; }
.half { flex: 1; }
.btn-save { width: 100%; background: #1bc5bd; color: white; border: none; padding: 12px; border-radius: 6px; font-weight: bold; cursor: pointer; }
</style>